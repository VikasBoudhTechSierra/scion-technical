...
const Home = () => {
  ...
  const paragraphs = [
    //para 1
    "Tech Sierra Technology stands as a nationally recognized leader in IT staffing, specializing in recruitment across a diverse spectrum including engineering, IT, data, security, product, design, informatics, and executive leadership sectors. Our proactive outbound recruiting approach ensures the formation of high-performing technology teams precisely tailored to your needs.",
    //para 2
  ...
  const paragraphPartTwo = [
    "Our team connects with, recruits, and delivers the IT, engineering, and creative leaders of tomorrow. Our talented technology candidates are experienced in working with a variety of emerging technologies, programming languages, hardware, platforms, and environments.",
