...
const Hire = () => {
    ...
    const Crousel_Card = [
        {
            id: 1,
            details: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat ipsum consequatur earum nulla quam autem tempore amet, ducimus accusantium voluptatum reiciendis accusamus esse commodi? Error nihil deleniti adipisci dolorem veritatis!",
            ...
            <div className="hire_section">
                <div className="hire">
                    <div className="itContainer wrapper">
                        ...
                        <TemporaryStuffingHeading h1={["Employers | Request Technology Staff "]}
                            h3={[
                        ...
                        <div className="itContentContainer">
                            <div className="itLeftContainer">
                                <TemporaryStuffingParaSection paragraph1="Scion Technology is a leading recruitment firm for tech-based employers. Specializing in executive search, direct hire, and contract roles across tech, engineering, creative, marketing, sales, and IT. Our passionate recruiters connect clients with top talent locally and nationally since 2006."
                ...
                <div className="wrapper">
                    ...
                    <div className="form_container">
                        <div className="form_header">
                            <h3>READY TO HIRE? PLEASE TELL US A BIT ABOUT YOUR TEAM AND THE ROLE YOU ARE HIRING FOR.</h3>
                        </div>
                        <form action="">
                            ...
                            <div className="input_container">
                                ...
                                <div className="input_row_field">
                                    <div className="input_field">
                                        <label htmlFor="Position_Type">Position Type <span>*</span></label>
                                        <select name="cars" id="cars" >
                                            ...
                                            <option value="audi">Apply With US As A Candidate </option>
                                        </select>
                                    </div>

                                    <div className="input_field">
                                        <label htmlFor="Position_Location">Position Location <span>*</span></label>
                                        <select name="cars" id="cars" >
                                            <option value="volvo">Temporary / Contract</option>
                                            <option value="saab">Direct Hire / Permanent</option>
                                            <option value="mercedes">Executive Search</option>
                                ...
                                <div className="input_row_field">
                                    <div className="input_field">
                                        <label htmlFor="title_position">Title of Position <span>*</span></label>
                                        <input type="text" name="title_position" />
                                    </div>

                                    <div className="input_field">
                                        <label htmlFor="file">upload job Description, If Available </label>
                                ...
                                <div className="textare_field">
                                    <label htmlFor="Website">Or Alternately, Describe Position </label>
                                ...
                                <div className="input_field">
                                    <label htmlFor="Position_Type">How Did You Hear About us?</label>
                                    <select name="cars" id="cars" >
                    ...
                    <div class="hire_section_btm_container">
                        ...
                        <ul className="hire_section_btm_links">
                            ...
                            <li><a href="#FIXME">HIRE TALENT</a></li>
                            <li><a href="#FIXME">EXPERTISE</a></li>
                            <li><a href="#FIXME">IT STAFFING</a></li>
                            <li><a href="#FIXME">CREATIVE STAFFING</a></li>
                        </ul>
                    </div>
