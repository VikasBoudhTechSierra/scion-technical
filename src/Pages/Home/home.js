...
const Home = () => {
  ...
  const paragraphs = [
    //para 1
    "Tech Sierra stands as a nationally recognized leader in IT staffing, specializing in recruitment across a diverse spectrum including engineering, IT, data, security, product, design, informatics, and executive leadership sectors. Our proactive outbound recruiting approach ensures the formation of high-performing technology teams precisely tailored to your needs.",
    //para 2
