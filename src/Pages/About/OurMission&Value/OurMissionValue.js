        ...
        <div className="wrapper">
          ...
          <div className="mission-statement-ctn">
            ...
            <p className="mission-statement">
              It is our mission to diligently provide the nation's best staffing and
              executive search services, guided by socially conscious business
              practices. At Scion, we lead by example, consistently promoting
              operational excellence, delivering employee and client satisfaction,
              upholding professional ethics, celebrating diversity, equity, and
              inclusion, and fostering the true potential of our industry.
            </p>
          </div>
          <div className="mission-values-main">
            <div>
              ...
              <p className="subsection-content">
                Scion Technology takes its name from a sector that portion of a plant
                which, when introduced to a new foundation or growth area, we
                strategically place new talent to improve organizational growth.
              </p>
              ...
              <div className="value-section">
                ...
                <p className="value-description">
                  We believe diverse teams are more than a strength; they are essential
                  for creating value and competitive advantage. We strive for
                  applications, interviews, coaching processes are inclusive, equitable,
                  and bias-free all the while ensuring we are accurately representing our
                  firm and essentially in the partnerships and connections we traditionally
                  create.
                </p>
              </div>
              ...
              <div className="value-section">
                ...
                <p className="value-description">
                  We do the right things. We remain steadfastly to our candidates, clients,
                  and stakeholders. We communicate honestly and transparently, act with
                  respect, and we deliver on our commitments.
                </p>
              </div>
            ...
            <div>
              <div className="button-container">
                <span className="primary-button">Ready to launch your search?</span>
                <p><a class="employer_cta_button" href="/contact-us">Connect With Us</a></p>
              </div>
          ...
          <div class="mission-section-btm-container">
            ...
            <h2 class="section-main-title">
                Learn More About TechSierra
            </h2>
         
          <ul className="mission-section-btm-links">
            <li><a href="#FIXME">request staff</a></li>
            <li><a href="#FIXME">search open positions</a></li>
            <li><a href="#FIXME">our clients</a></li>
            <li><a href="#FIXME">why choose teachSierra</a></li>
          </ul>
        </div>
        </div>
